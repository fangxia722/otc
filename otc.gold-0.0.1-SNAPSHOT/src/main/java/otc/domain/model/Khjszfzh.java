...
public class Khjszfzh {
    ...
    public Date getZjsysj() {
        return zjsysj;
    }

    public void setZjsysj(Date zjsysj) {
        this.zjsysj = zjsysj;
    }
