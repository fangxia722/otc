...
public interface KhxxDao {
    ...
    @Results({
        ...
        @Result(column="KHH", property="khtzzhs",many=@Many(fetchType=FetchType.LAZY,select = "selectKhtzzh")),
        @Result(column="KHH", property="khjszfzhs",many=@Many(fetchType=FetchType.LAZY,select = "queryKhjszfzhs"))
    })
    Khxx selectByPrimaryKey(Long id);
    
    @SelectProvider(type=KhxxSqlProvider.class, method="querySelective")
    @Results({
        @Result(column="ID", property="id", jdbcType=JdbcType.DECIMAL, id=true),
        @Result(column="KHH", property="khh", jdbcType=JdbcType.VARCHAR),
        @Result(column="KHXM", property="khxm", jdbcType=JdbcType.VARCHAR),
        ...
        @Result(column="GJ", property="gj", jdbcType=JdbcType.DECIMAL),
        @Result(column="MZ", property="mz", jdbcType=JdbcType.DECIMAL),
        @Result(column="KHH", property="khtzzhs",many=@Many(fetchType=FetchType.LAZY,select = "otc.domain.dao.KhtzzhDao.selectKhtzzh")),
        @Result(column="KHH", property="khjszfzhs",many=@Many(fetchType=FetchType.LAZY,select = "otc.domain.dao.KhjszfzhDao.queryKhjszfzhs"))
    })
    List<Khxx> selectKhs(Khxx khxx);
